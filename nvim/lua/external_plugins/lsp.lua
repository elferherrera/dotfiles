  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd('LspAttach', {
      ...
      callback = function(event)
        ...
        -- Fuzzy find document and workspace diagnostics
        ...
        map('<leader>cgd', vim.lsp.buf.definition, '[G]oto [D]eclaration')
    ...
    require('mason-lspconfig').setup {
      ...
      handlers = {
        function(server_name)
          ...
          local blink_capabilities = require('blink.cmp').get_lsp_capabilities(server_capabilities)
          server.capabilities = blink_capabilities
