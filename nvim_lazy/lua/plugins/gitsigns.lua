return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>gs', '<Cmd>Gitsigns stage_hunk<CR>', { noremap = true, silent = true })
    vim.keymap.set('n', '<leader>gr', '<Cmd>Gitsigns stage_buffer<CR>', { noremap = true, silent = true })
